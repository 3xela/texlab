...
\penum
\item 
Without loss of generality translate so that $x=0$. We compute:
\begin{align*}
	\frac{1}{\pi r^2} \int_{B_r(0)} u(s, \theta) ds d\theta  & = \frac{1}{\pi r^2} \int_0^r \int_{C_s(0)} s\cdot  u(s, \theta ) d\theta ds \tag{Fubinis Theorem}
	\\ & = \frac{1}{\pi r^2} \int_0^r 2\pi s  \cdot u(0) ds \tag{change of variables + mean value property}
	\\ & = \frac{2u(0)}{r^2} \int_0^r s ds
	\\ & = u(0) \tag{integrating}
\end{align*}
...
\item Changing to spherical coordinates, we have that $v(r,\theta) = u(1/r, \theta)$. It follows from the chain rule that 
	$$\Delta v = v_{rr} + \frac{1}{r} v_r + \frac{1}{r^2}v_{\theta \theta} = (u(1/r, \theta))_{rr} + \frac{1}{r}(u(1/r), \theta)_{r}  + \frac{1}{r^2}(u(1/r, \theta))_{\theta \theta} = \frac{1}{r^2}u_{rr} + \frac{1}{r^3}u_r + \frac{1}{r^4}u_{\theta \theta}. $$
Therefore we have that $\Delta v = \frac{1}{r^2}\Delta u$. 
