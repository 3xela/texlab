...
\item Rotations correspond to the vector field $ \frac{ \partial  }{ \partial \theta }$. Our Hamiltonian function $J$ must satisfy:
...
\begin{align*}
	- \left( \omega_B^\# \right)^{-1} \left( dH \right) & = - \left( \omega_B^\# \right)^{-1} \left(   \frac{ p_\theta^2 \cos \varphi }{ \sin^3 \varphi } \frac{ \partial  }{ \partial p_\varphi } + p_\varphi \frac{ \partial  }{ \partial \varphi } + \frac{ p_\theta }{ \sin^2 \varphi } \frac{ \partial  }{ \partial \theta } \right)\
	\\ & = \frac{ p_\theta^2 \cos \varphi }{ \sin^3 \varphi } \left( \omega_B^\# \right)^{-1} \left( d \varphi \right)- p_\theta \left( \omega_B^\# \right)^{-1} \left( dp_\varphi \right)- \frac{ p_\theta }{ \sin^2 \varphi } \left( \omega_B^\# \right)^{-1} \left( dp_\theta \right)
	\\ & = \frac{ p_\theta^2 \cos \varphi}{ \sin^3 \varphi } \frac{ \partial  }{ \partial p_\varphi } + p_\theta \left( b \sin \varphi \frac{ \partial  }{ \partial p_\theta } + \frac{ \partial  }{ \partial \varphi } \right) - \frac{ p_\theta }{ \sin^2 \varphi } \left( b \sin \varphi \frac{ \partial  }{ \partial p_\varphi } - \frac{ \partial  }{ \partial \theta } \right)
\end{align*}
