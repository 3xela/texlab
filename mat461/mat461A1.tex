...
Since $g$ is Galilean, it must preserve the time interval. Suppose that we have two spacetimes points $(y,t_1), (y,t_2)$ so that $t( (x,t_1) -(y,t_2)  ) = t_1 - t_2$. We must also have that $t(g(x,t_1) - g(y, t_2)) = t_1 - t_2$. It follows that:
...
$$\norm{x- y} = \norm{g(x,t) - g(y,t)} = \norm{A_{11}x - A_{11} y}.$$
Therefore $A_{11}$ must be an orthogonal matrix possibly depending on $t$. Relabelling we have that 
