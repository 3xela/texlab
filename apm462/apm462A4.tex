...
We set 
$$g_0 = Qx_0 = \bmat{4 & \sqrt{3} \\ \sqrt{3} & 3} \bmat{10 \\ -20}=\bmat{40 - 20 \sqrt{3} \\ 10\sqrt{3} -60} .$$
Therefore
$$ \alpha_0 = -\frac{ g_0\cdot v_0 }{\lambda_0 \norm{v_0}^2}= - \frac{ \bmat{40 - 20 \sqrt{3} \\ 10\sqrt{3} -60} \cdot \bmat{ 1-\sqrt{13} \\ 2\sqrt{3}}}{ (\frac{7-\sqrt{13}}{2})  \cdot \norm{\bmat{ 1-\sqrt{13} \\ 2\sqrt{3}} }^2} =\frac{5\left(3\sqrt{13}+13\sqrt{3}+\sqrt{39}\right)}{39}.	$$ 
Therefore
$$ x_1 = x_0 + \alpha_0 v_0  =\begin{bmatrix}\frac{65+5\sqrt{13}-20\sqrt{39}}{13}\\ \frac{-130\sqrt{3}+30\sqrt{13}+10\sqrt{39}}{13\sqrt{3}}\end{bmatrix}. $$ 
We now find $g_1 = Qx_1$:
$$ g_1 = Qx_1 = \begin{bmatrix}4&\sqrt{3}\\ \:\sqrt{3}&3\end{bmatrix}\begin{bmatrix}\frac{65+5\sqrt{13}-20\sqrt{39}}{13}\\ \:\:\frac{-130\sqrt{3}+30\sqrt{13}+10\sqrt{39}}{13\sqrt{3}}\end{bmatrix}= \begin{bmatrix}\frac{260+50\sqrt{13}-70\sqrt{39}-130\sqrt{3}}{13}\\ \frac{65\sqrt{3}+35\sqrt{39}-30\sqrt{13}-390}{13}\end{bmatrix} .$$
We compute $\alpha_1$, 
$$ \alpha_1= - \frac{ g_1 \cdot v_1}{\lambda_1 \norm{v_1}^2 }= -\frac{5\left(3\sqrt{13}+\sqrt{39}-13\sqrt{3}\right)}{39} $$ 
Finally, we compute 
$$x_2 = x_1 + \alpha_1 v_1=\begin{bmatrix}\frac{65+5\sqrt{13}-20\sqrt{39}}{13}\\ \frac{-130\sqrt{3}+30\sqrt{13}+10\sqrt{39}}{13\sqrt{3}}\end{bmatrix}-\frac{5\left(3\sqrt{13}+\sqrt{39}-13\sqrt{3}\right)}{39} \bmat{1+ \sqrt{13} \\ 2\sqrt{3}} =0.$$
