...
\item $\eL = \frac{ \left( u'(x)+1 \right)^2 }{ u^2(x) +1 }$:	
	$$ \frac{ d }{ dx } \left( \frac{ \partial \eL }{ \partial u' } \right) = \frac{ d  }{ dx } 2 \frac{ u'(x)-1 }{ u^2(x) +1 } = 2\frac{u
^{\prime \prime}(x) (u^2(x) +1) - (u'(x) -1) 2u(x) u'(x) }{ (u(x)^2+1)^2 }$$
 $$ \frac{ \partial \eL  }{ \partial u } = \frac{ 2u(x) (u'(x) -1)^2 }{ (u^2(x) +1)^2 }. $$ 
 Therefore:
 $$ \frac{u
^{\prime \prime}(x) (u^2(x) +1) - (u'(x) -1) 2u(x) u'(x) }{ (u(x)^2+1)^2 }= \frac{ u(x) (u'(x) -1)^2 }{ (u^2(x) +1)^2 }.$$ 
\epenum	
\end{document}
