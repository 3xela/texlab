...
Therefore $$\sum_{\xi \in \Z^n} (1+|\xi|^2)^2 |\hat{u}(\xi)|^2  = \sum_{|\xi |< M} (1+|\xi|^2)^2 |\hat{u}(\xi)|^2 + \frac{2}{\lambda }\sum_{|\xi| \geq M} (1+|\xi|^2)^2 \frac{|\hat{f}(\xi)|}{|\xi|^4}.$$
...
If $f$ is additionally orthogonal to the kernel of $L$ 
\item 
\epenum
