...
\end{align*}
\item If $u$ is a critical point of $A$, we must have that 
$$0 = \sum_{i=1}^n \int_{\Omega} \frac{u_i \cdot v_i}{\sqrt{1 + |\grad u + \ep \grad v|^2}}dx$$
\item 
\item We cannot apply Sobolov bootstrap because this PDE is nonlinear
\epenum
